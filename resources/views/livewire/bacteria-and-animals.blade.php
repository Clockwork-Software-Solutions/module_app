...
<div >
    <div class="p-6">
  <div class="flex">
  <h1 id="textTitle" class="text-3xl mx-14 mb-10">Classify Bacteria and Animals</h1>
  ...
  <img id="drag1" class="mx-3 rounded-full col-span-1" src="/storage/images/worm.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag2" class="mx-3 rounded-full col-span-1" src="/storage/images/zooplankton.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag3" class="mx-3 rounded-full col-span-1" src="/storage/images/plankton.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag4" class="mx-3 rounded-full col-span-1" src="/storage/images/ant.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag5" class="mx-3 rounded-full col-span-1" src="/storage/images/bacteria.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag6" class="mx-3 rounded-full col-span-1" src="/storage/images/bacteria1.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag7" class="mx-3 rounded-full col-span-1" src="/storage/images/bacteria2.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
  <img id="drag8" class="mx-3 rounded-full col-span-1" src="/storage/images/bacteria3.png" draggable="true" ondragstart="drag(event)" width="100" height="100">
...
<script>
  ...
  $(window).on('load', function() {
    ...
    var elements = [drag1, drag2, drag3, drag4, drag5, drag6, drag7, drag8];
...
function drop(ev) {
  ...
  var divId = ev.target.id;
    ...
    if((divId === "div1" && data === "drag1") || (divId === "div1" && data === "drag2") || (divId === "div1" && data === "drag3") || (divId === "div1" && data === "drag4")){
    ...
    }else if((divId === "div2" && data === "drag5") || (divId === "div2" && data === "drag6") || (divId === "div2" && data === "drag7") || (divId === "div2" && data === "drag8")){
      ev.target.appendChild(document.getElementById(data));
        //make the draggable false
        document.getElementById(data).draggable = false;
        corrects++;
